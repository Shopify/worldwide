  ...
  class TimeZoneTest < ActiveSupport::TestCase
    ...
    def iana_data_input_expected
      [
        ...
        ["Africa/Tripoli", "Africa/Harare"],
        ["Africa/Tunis", "Africa/Algiers"],
        ["Africa/Windhoek", "Africa/Harare"],
        ...
        ["America/Asuncion", "America/Halifax"],
        ...
        ["America/Indiana/Marengo", "America/Indiana/Indianapolis"],
        ["America/Indiana/Petersburg", "America/Indiana/Indianapolis"],
        ["America/Indiana/Tell_City", "America/Chicago"],
        ["America/Indiana/Vevay", "America/Indiana/Indianapolis"],
        ["America/Indiana/Vincennes", "America/Indiana/Indianapolis"],
        ["America/Indiana/Winamac", "America/Indiana/Indianapolis"],
        ...
        ["America/Scoresbysund", "America/Godthab"],
        ...
        ["America/Tegucigalpa", "America/Mexico_City"],
        ...
        ["Antarctica/Macquarie", "Australia/Melbourne"],
        ["Antarctica/Mawson", "Asia/Karachi"],
        ["Antarctica/McMurdo", "Pacific/Auckland"],
        ["Antarctica/Palmer", "America/Sao_Paulo"],
        ["Antarctica/Rothera", "America/Sao_Paulo"],
        ["Antarctica/South_Pole", "Pacific/Auckland"],
        ["Antarctica/Syowa", "Asia/Riyadh"],
        ["Antarctica/Troll", "Africa/Algiers"],
        ["Antarctica/Vostok", "Asia/Karachi"],
        ["Arctic/Longyearbyen", "Europe/Berlin"],
        ["Asia/Aden", "Asia/Riyadh"],
        ["Asia/Almaty", "Asia/Almaty"],
        ["Asia/Amman", "Europe/Istanbul"],
        ["Asia/Anadyr", "Asia/Kamchatka"],
        ["Asia/Aqtau", "Asia/Almaty"],
        ["Asia/Aqtobe", "Asia/Almaty"],
        ["Asia/Ashgabat", "Asia/Almaty"],
        ["Asia/Ashkhabad", "Asia/Almaty"],
        ...
        ["Atlantic/Stanley", "America/Argentina/Buenos_Aires"],
        ...
        ["Brazil/DeNoronha", "Atlantic/South_Georgia"],
        ["Brazil/East", "America/Sao_Paulo"],
        ["Brazil/West", "America/Caracas"],
        ...
        ["Etc/GMT+6", "America/Mexico_City"],
        ["Etc/GMT+7", "America/Phoenix"],
        ["Etc/GMT+8", "America/Juneau"],
        ["Etc/GMT+9", "America/Juneau"],
        ["Etc/GMT-0", "Etc/UTC"],
        ...
        ["Etc/GMT-14", "Pacific/Apia"],
        ["Etc/GMT-2", "Africa/Harare"],
        ["Etc/GMT-3", "Africa/Nairobi"],
        ["Etc/GMT-4", "Asia/Baku"],
        ["Etc/GMT-5", "Asia/Almaty"],
        ["Etc/GMT-6", "Asia/Dhaka"],
        ["Etc/GMT-7", "Asia/Bangkok"],
        ["Etc/GMT-8", "Asia/Chongqing"],
        ["Etc/GMT-9", "Asia/Yakutsk"],
        ["Etc/GMT0", "Etc/UTC"],
        ...
        ["Indian/Mahe", "Asia/Yerevan"],
        ["Indian/Maldives", "Asia/Karachi"],
        ["Indian/Mauritius", "Asia/Yerevan"],
        ["Indian/Mayotte", "Africa/Nairobi"],
        ["Indian/Reunion", "Asia/Yerevan"],
        ["Iran", "Asia/Tehran"],
        ...
        ["Pacific/Funafuti", "Pacific/Majuro"],
        ...
        ["Pacific/Marquesas", "Pacific/Honolulu"],
        ...
        ["Pacific/Palau", "Asia/Yakutsk"],
        ["Pacific/Pitcairn", "America/Juneau"],
        ["Pacific/Pohnpei", "Pacific/Noumea"],
        ...
        ["Pacific/Wake", "Pacific/Majuro"],
        ["Pacific/Wallis", "Pacific/Majuro"],
        ...
        ["US/Indiana-Starke", "America/Indiana/Indianapolis"],
